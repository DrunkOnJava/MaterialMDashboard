...
export const Ecommerce = (): JSX.Element => {
  ...
  const renderProductCard = (product: Product) => {
    return (
      <Card
        key={product.id}
        className="rounded-xl overflow-hidden shadow-light-theme-shadow-medium"
      >
        <div className="relative">
          ...
          {product.isSale && <Badge className="absolute top-3 left-3 bg-actionwarning">Sale</Badge>}
        </div>
        <CardContent className="pt-4">
          ...
          <div className="flex items-center mt-3">
            {product.originalPrice ? (
              <>
                <p className="text-xl font-semibold text-blackblack-100">
                  ${product.price.toFixed(2)}
                </p>
                <p className="text-sm text-blackblack-60 line-through ml-2">
        ...
        <CardFooter className="pt-0 flex gap-2">
          <Button variant="primary" className="w-full" onClick={() => addToCart(product)}>
  ...
  return (
    <>
      <div className="py-6 px-6 bg-white border-b border-[#e4ebf0]">
        ...
        <p className="text-blackblack-60 mt-1">Manage your products, orders, and inventory</p>
      </div>
      ...
      <main className="p-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="mb-6 bg-white p-1 rounded-lg">
                ...
                <TabsTrigger value="cart" className="px-6">
                  Shopping Cart
                </TabsTrigger>
                <TabsTrigger value="tracking" className="px-6">
                  Order Tracking
                </TabsTrigger>
                    ...
                    <Card className="rounded-xl shadow-light-theme-shadow-medium">
                      <CardHeader className="border-b border-[#111c2d1a] px-6 py-4">
                        <CardTitle className="font-normal text-lg tracking-[-0.18px] leading-[25.2px] text-blackblack-100">
                          Shopping Cart{' '}
                          <span className="text-blackblack-60">({cart.length} items)</span>
                        </CardTitle>
                      </CardHeader>
                                ...
                                <div key={item.product.id} className="p-6 flex">
                                  ...
                                  <div className="ml-4 flex-1">
                                    <div className="flex justify-between">
                                      <div>
                                        <h3 className="font-medium text-blackblack-100">
                                          {item.product.name}
                                        </h3>
                                        ...
                                        <div className="flex items-center gap-3 mt-3">
                                          <Button
                                            ...
                                            onClick={() =>
                                              updateCartQuantity(item.product.id, 'decrement')
                                            }
                                          >
                                            <Minus className="h-3 w-3" />
                                          </Button>
                                          <span className="text-blackblack-100">
                                            {item.quantity}
                                          </span>
                                          <Button
                                            variant="outline"
                                            ...
                                            className="h-8 w-8 rounded-full"
                                            onClick={() =>
                                              updateCartQuantity(item.product.id, 'increment')
                                            }
                                          >
                      ...
                      <CardContent className="p-6">
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-between">
                            ...
                            <p className="font-bold text-lg text-blackblack-100">
                              ${cartTotal.toFixed(2)}
                            </p>
                          </div>
                          ...
                          {/* Promo code */}
                          <div className="pt-6">
                            <p className="text-sm font-medium text-blackblack-100 mb-2">
                              Have a promo code?
                            </p>
                              ...
                              <div className="flex flex-col md:flex-row gap-6">
                                <div className="flex items-center gap-4 flex-1">
                                  ...
                                  <div>
                                    ...
                                    <h3 className="font-medium text-blackblack-100 mt-1">
                                      {order.product.name}
                                    </h3>
                                ...
                                <div className="flex flex-col gap-2">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-sm text-blackblack-60">
                                      <span className="font-medium text-blackblack-100">
                                        Estimated Delivery:
                                      </span>{' '}
                                ...
                                <div className="relative">
                                  ...
                                  <div className="flex justify-between pt-6">
                                    <div className="text-center">
                                      <div
                                        className={`mx-auto h-6 w-6 rounded-full flex items-center justify-center mb-2 ${order.status !== 'cancelled' ? 'bg-actionsuccess text-white' : 'bg-blackblack-20 text-blackblack-60'}`}
                                      >
                                        <CheckCircle className="h-4 w-4" />
                                      </div>
                                      <p className="text-xs font-medium text-blackblack-100">
                                        Order Placed
                                      </p>
                                    </div>
                                    <div className="text-center">
                                      <div
                                        className={`mx-auto h-6 w-6 rounded-full flex items-center justify-center mb-2 ${(order.status === 'processing' || order.status === 'shipped' || order.status === 'delivered') && order.status !== 'cancelled' ? 'bg-actionsuccess text-white' : 'bg-blackblack-20 text-blackblack-60'}`}
                                      >
                                        <CheckCircle className="h-4 w-4" />
                                      </div>
                                      <p className="text-xs font-medium text-blackblack-100">
                                    ...
                                    <div className="text-center">
                                      <div
                                        className={`mx-auto h-6 w-6 rounded-full flex items-center justify-center mb-2 ${(order.status === 'shipped' || order.status === 'delivered') && order.status !== 'cancelled' ? 'bg-actionsuccess text-white' : 'bg-blackblack-20 text-blackblack-60'}`}
                                      >
                                        <CheckCircle className="h-4 w-4" />
                                      </div>
                                      <p className="text-xs font-medium text-blackblack-100">
                                    ...
                                    <div className="text-center">
                                      <div
                                        className={`mx-auto h-6 w-6 rounded-full flex items-center justify-center mb-2 ${order.status === 'delivered' && order.status !== 'cancelled' ? 'bg-actionsuccess text-white' : 'bg-blackblack-20 text-blackblack-60'}`}
                                      >
                                        <CheckCircle className="h-4 w-4" />
                                      </div>
                                      <p className="text-xs font-medium text-blackblack-100">
                    ...
                    <CardContent className="p-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {mockCategories.map(category => (
                          <Card
                            key={category.id}
                            className="rounded-xl shadow-sm hover:shadow-light-theme-shadow-medium transition-all cursor-pointer"
                          >
                          ...
                          >
                            <div className="h-40 bg-light-themeprimarylight-blue relative">
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-center">
                                  <h3 className="text-xl font-semibold text-blackblack-100">
                                    {category.name}
                                  </h3>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {[
                          ...
                          <Badge
                            key={tag}
                            variant="outline"
                            className="py-1.5 px-3 cursor-pointer hover:bg-light-themeprimarylight-blue"
                          >
