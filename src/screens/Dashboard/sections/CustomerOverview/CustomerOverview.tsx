          ...
          <CardContent className="flex p-6 items-start">
            <div className="flex-1">
              ...
              <div className="flex items-center mt-2">
                ...
                <span className="text-xs font-medium text-actionsuccess">8.4% from last month</span>
              </div>
            </div>
          ...
          <CardContent className="flex p-6 items-start">
            <div className="flex-1">
              ...
              <div className="flex items-center mt-2">
                ...
                <span className="text-xs font-medium text-actionsuccess">5.2% from last month</span>
              </div>
            </div>
          ...
          <CardContent className="flex p-6 items-start">
            <div className="flex-1">
              ...
              <div className="flex items-center mt-2">
                ...
                <span className="text-xs font-medium text-actionsuccess">2.3% from last month</span>
              </div>
            </div>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex gap-4 w-full md:w-auto">
              <Select
                value={segmentFilter}
                onValueChange={value => setSegmentFilter(value as CustomerSegment)}
              >
                ...
                {customerSegments.map(segment => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <span
                        className={`${segmentFilter === segment.id ? 'text-light-themeprimaryblue font-medium' : 'text-blackblack-100'}`}
                      >
                        {segment.name}
                      </span>
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-start space-x-3 pb-2 border-b border-[#111c2d1a] last:border-b-0 last:pb-0"
                  >
                    ...
                    <div>
                      <p className="font-medium text-blackblack-100">
                        <span className="text-light-themeprimaryblue">{activity.name}</span>{' '}
                        {activity.action}
                      </p>
                ...
                <tbody>
                  {filteredCustomers.map(customer => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6 font-medium text-blackblack-100">
                        {customer.totalSpent}
                      </td>
                      ...
                      <td className="py-4 px-6">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSegmentBadgeClass(customer.segment)}`}
                        >
                          {customer.segment === 'vip'
                            ? 'VIP'
                            : customer.segment.charAt(0).toUpperCase() +
                              customer.segment.slice(1).replace('-', ' ')}
                        </span>
                      </td>
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-full bg-light-themeprimarylight-blue flex items-center justify-center overflow-hidden">
                  {selectedCustomer.avatar ? (
                    ...
                    <span className="text-2xl text-light-themeprimaryblue font-medium">
                      {selectedCustomer.name.charAt(0)}
                    </span>
                  )}
                </div>
                <div>
                  <h3 className="text-xl font-medium text-blackblack-100">
                    {selectedCustomer.name}
                  </h3>
                  <p className="text-blackblack-60">{selectedCustomer.email}</p>
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSegmentBadgeClass(selectedCustomer.segment)}`}
                    >
                      {selectedCustomer.segment === 'vip'
                        ? 'VIP'
                        : selectedCustomer.segment.charAt(0).toUpperCase() +
                          selectedCustomer.segment.slice(1).replace('-', ' ')}
                    </span>
                ...
                <div className="border border-[#111c2d1a] rounded-b-lg bg-white">
                  <TabsContent value="profile" className="p-6 m-0">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="text-sm font-medium text-blackblack-60 mb-2">
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          {[
                            ...
                            .slice(0, selectedCustomer.orderCount)
                            .map((order, index) => (
                              <tr
                                key={index}
                                className="border-b border-[#111c2d1a] last:border-b-0"
                              >
                                ...
                                <td className="py-3 px-4 font-medium text-blackblack-100">
                                  {order.amount}
                                </td>
                  ...
                  <TabsContent value="activity" className="p-6 m-0">
                    <div className="space-y-6">
                      <div>
                        <h4 className="text-sm font-medium text-blackblack-60 mb-4">
                          Recent Activity
                        </h4>
