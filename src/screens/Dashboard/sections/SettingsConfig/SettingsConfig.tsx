                    ...
                    <div className="space-y-4 pl-6 border-l-2 border-[#111c2d1a]">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-blackblack-60">
                            Campaign performance, analytics, etc.
                          </p>
                        </div>
                        <Switch
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  {mockUserRoles.map(role => (
                    <Card
                      key={role.id}
                      className="border border-[#111c2d1a] rounded-lg overflow-hidden"
                    >
                      <CardHeader className="bg-surfaceslightgray-10 py-4 px-6">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex gap-2">
                            ...
                            {role.id !== 'admin' && (
                              <Button variant="outline" size="sm" className="text-actionwarning">
                                Delete
                              </Button>
                            )}
                          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  {autoBackup && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-blackblack-100">
                          Backup Frequency
                        </label>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {[
                      {
                        date: '2025-03-16 03:00:00',
                        size: '42.8 MB',
                        createdBy: 'System (Automated)',
                      },
                      {
                        date: '2025-03-15 03:00:00',
                        size: '41.5 MB',
                        createdBy: 'System (Automated)',
                      },
                      {
                        date: '2025-03-14 03:00:00',
                        size: '40.9 MB',
                        createdBy: 'System (Automated)',
                      },
                      {
                        date: '2025-03-13 14:32:15',
                        size: '40.1 MB',
                        createdBy: 'John Doe (Manual)',
                      },
                      {
