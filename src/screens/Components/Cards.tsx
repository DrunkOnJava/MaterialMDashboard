              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p>
                        This is the main content of the card. It can contain text, images, or any
                        other elements.
                      </p>
                    </CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p>
                        This card includes a badge in the header to indicate status or importance.
                      </p>
                    </CardContent>
                    <CardFooter>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <Card className="bg-light-themesecondarylight-purple border-light-themesecondarypurple">
                    <CardHeader>
                      <CardTitle className="text-light-themesecondarypurple">
                        Secondary Card
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="overflow-hidden">
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-2 mb-2">
                      <Badge
                        variant="outline"
                        className="text-light-themeprimaryblue border-light-themeprimaryblue"
                      >
                        Technology
                      </Badge>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-blackblack-60 text-sm mb-3">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-blackblack-60 text-sm mt-3">
                      Join us for the biggest tech conference of the year with industry leaders and
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="md:w-2/3 p-6">
                        ...
                        <p className="text-blackblack-60 mb-4">
                          We are a team of passionate designers and developers creating innovative
                          solutions for businesses around the world. Our mission is to build
                  ...
                  <Card>
                    <div className="flex flex-col md:flex-row">
                      <div className="md:w-2/3 p-6">
                        <Badge className="mb-2 bg-light-themesecondarylight-purple text-light-themesecondarypurple">
                          Case Study
                        </Badge>
                        ...
                        <p className="text-blackblack-60 mb-4">
                          Learn how our team helped Company X redesign their website and optimize
                          their customer journey to achieve remarkable results in just three months.
                        </p>
