                  ...
                  <div className="space-y-4">
                    ...
                    <Accordion type="multiple" className="w-full">
                      <AccordionItem value="item-1">
                        ...
                        <AccordionContent>
                          This is the content for the first section. You can expand multiple
                          sections at once.
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="item-2">
                        ...
                        <AccordionContent>
                          This is the content for the second section. It can be expanded at the same
                          time as other sections.
                        </AccordionContent>
                      </AccordionItem>
                      <AccordionItem value="item-3">
                        <AccordionTrigger>Third Section</AccordionTrigger>
                        <AccordionContent>
                          This is the content for the third section. All sections can be expanded or
                          collapsed.
                        </AccordionContent>
                      </AccordionItem>
                    </Accordion>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <Accordion type="single" collapsible className="w-full">
                        <AccordionItem
                          value="item-1"
                          className="mb-2 border border-[#111c2d1a] rounded-md overflow-hidden"
                        >
                        ...
                        <AccordionItem
                          value="item-3"
                          className="border border-[#111c2d1a] rounded-md overflow-hidden"
                        >
                          <AccordionTrigger className="px-4 py-3 hover:bg-surfaceslightgray-10 bg-surfaceslightgray-10 [&[data-state=open]]:bg-light-themeprimarylight-blue [&[data-state=open]>div>svg]:text-light-themeprimaryblue [&[data-state=open]]:text-light-themeprimaryblue [&[data-state=open]>.chevron]:rotate-90">
                            <div className="flex items-center">
                              <span>Section 3</span>
                    ...
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      >
                        ...
                        <AccordionContent className="px-4 py-3 border-t">
                          <p>
                            Our pricing structure is based on a monthly subscription model. We offer
                            three tiers:
                          </p>
                          <ul className="list-disc ml-5 mt-2 space-y-1 text-blackblack-60">
                            ...
                            <li>
                              Professional: $19.99/month - Includes advanced features for
                              professionals
                            </li>
                            <li>
                              Enterprise: $49.99/month - Includes all features plus priority support
                              for teams
                            </li>
                          </ul>
                          <div className="mt-3">
                      ...
                      >
                        ...
                        <AccordionContent className="px-4 py-3 border-t">
                          <p>
                            Yes, we offer a 14-day free trial for all subscription tiers. During the
                            trial period, you'll have access to all features available in the
                            selected tier. No credit card is required to start the trial.
                          </p>
                          <div className="mt-3">
                      ...
                      <AccordionItem value="item-5" className="border rounded-md overflow-hidden">
                        ...
                        <AccordionContent className="px-4 py-3 border-t">
                          ...
                          <p className="mt-2">
                            Enterprise customers have access to priority support with faster
                            response times.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between pb-3 border-b">
                              ...
                              <div className="flex border border-[#111c2d1a] rounded-md overflow-hidden">
                                <button className="px-3 py-1.5 bg-light-themeprimarylight-blue text-light-themeprimaryblue font-medium">
                                  Light
                                </button>
                        ...
                        <AccordionContent className="pt-4 pb-3 px-4">
                          <div className="space-y-4">
                            {[
                              ...
                              <div
                                key={index}
                                className={`flex items-center justify-between ${index < 3 ? 'pb-3 border-b' : ''}`}
                              >
                                <div>
                                ...
                                <div
                                  className={`h-6 w-11 rounded-full ${index !== 2 ? 'bg-light-themeprimaryblue' : 'bg-blackblack-20'} relative cursor-pointer`}
                                >
                                  <div
                                    className={`absolute ${index !== 2 ? 'right-1' : 'left-1'} top-1 h-4 w-4 rounded-full bg-white`}
                                  ></div>
                                </div>
                              </div>
                            ))}
