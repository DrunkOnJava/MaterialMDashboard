                      ...
                      <div className="px-6 pb-6">
                        ...
                        <div className="text-center mt-2">
                          ...
                          <div className="flex justify-center mt-2 gap-1">
                            ...
                            <Badge className="bg-light-themesecondarylight-purple text-light-themesecondarypurple">
                              UI/UX
                            </Badge>
                          </div>
                        </div>
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-blackblack-60 text-xs mt-1">
                        ...
                        <div className="text-center">
                          ...
                          <div className="mt-4 flex justify-center gap-2">
                            ...
                            <Avatar className="h-8 w-8 bg-light-themeprimarylight-blue">
                              <AvatarFallback className="text-light-themeprimaryblue text-xs">
                                +4
                              </AvatarFallback>
                            </Avatar>
                          </div>
                          ...
                          <div className="flex flex-col space-y-2">
                            ...
                            <div className="flex gap-2 justify-end">
                              <div className="bg-light-themeprimarylight-blue p-2 rounded-lg rounded-tr-none max-w-[70%]">
                                <p className="text-sm">
                                  Sure, let me finish this task and I'll call you in 5 minutes.
                                </p>
