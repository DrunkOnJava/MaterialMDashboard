                  ...
                  <div className="space-y-4">
                    {isVisible1 && (
                      <Alert className="bg-light-themeprimarylight-blue border-light-themeprimaryblue">
                        ...
                        <AlertDescription>
                          This is an informational alert. It provides general information to the
                          user.
                        </AlertDescription>
                        <Button
                          variant="ghost"
                    ...
                    {isVisible2 && (
                      <Alert className="bg-actionsuccess-light border-actionsuccess">
                        ...
                        <AlertDescription>
                          This is a success alert. It confirms that an action has been completed
                          successfully.
                        </AlertDescription>
                        <Button
                          variant="ghost"
                    ...
                    {isVisible3 && (
                      <Alert className="bg-actionalert-light border-actionalert">
                        ...
                        <AlertDescription>
                          This is a warning alert. It notifies the user about something that
                          requires attention.
                        </AlertDescription>
                        <Button
                          variant="ghost"
                  ...
                  <div className="space-y-4">
                    <Alert className="bg-light-themeprimarylight-blue border-light-themeprimaryblue">
                      ...
                      <AlertDescription className="flex justify-between items-center">
                        <span>
                          Your trial period ends in 7 days. Upgrade now to continue using all
                          features.
                        </span>
                        <Button
                          size="sm"
                          className="bg-light-themeprimaryblue hover:bg-light-themeprimaryblue/90 text-white ml-4"
                        >
                          Upgrade
                        </Button>
                      </AlertDescription>
                    ...
                    <Alert className="bg-actionsuccess-light border-actionsuccess">
                      ...
                      <AlertDescription className="flex justify-between items-center">
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          className="border-actionsuccess text-actionsuccess hover:bg-actionsuccess/10 ml-4"
                        >
                          Resend Email
                        </Button>
                      </AlertDescription>
                    ...
                    <Alert className="border-actionalert bg-actionalert-light">
                      ...
                      <AlertDescription>
                        <div className="mb-2">
                          Your browser version is outdated and may have security vulnerabilities.
                        </div>
                        <div className="flex gap-3">
                          <Button
                            size="sm"
                            className="bg-actionalert hover:bg-actionalert/90 text-white"
                          >
                            Update Now
                          </Button>
                          <Button
                        ...
                        <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-[#111c2d1a]">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-blackblack-60">
                                There was an unsuccessful login attempt from a new location.
                              </p>
                            </div>
                          </div>
                          <Button variant="ghost" size="icon" className="h-8 w-8">
