              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <p className="text-blackblack-80 mb-6">
                    Our grid system is built with Tailwind CSS and provides a 12-column layout by
                    default. The grid is responsive and adapts to different screen sizes
                    automatically.
                  </p>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-6 gap-4">
                      {[...Array(6)].map((_, i) => (
                        <div
                          key={i}
                          className="bg-light-themeprimarylight-blue p-4 text-light-themeprimaryblue text-center rounded"
                        >
                          {i + 1}
                        </div>
                      ))}
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-12 gap-4">
                      {[...Array(12)].map((_, i) => (
                        <div
                          key={i}
                          className="bg-light-themeprimarylight-blue p-2 text-light-themeprimaryblue text-center rounded"
                        >
                          {i + 1}
                        </div>
                      ))}
            ...
            <Card className="rounded-xl shadow-light-theme-shadow-medium">
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <p className="text-blackblack-80 mb-6">
                    The grid automatically adjusts based on screen size. You can also explicitly
                    control the number of columns at different breakpoints.
                  </p>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-sm text-blackblack-60 mb-4">
                      Different layouts at different screen sizes (resize your browser to see the
                      change)
                    </p>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <p className="text-sm text-blackblack-60 mb-2">
                          Different Row & Column Gaps (gap-x-8 gap-y-4)
                        </p>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="border border-[#111c2d1a] rounded-lg p-4 mb-4">
                      ...
                      >
                        <div
                          className="bg-light-themeprimarylight-blue p-4 text-light-themeprimaryblue rounded col-span-full"
                          style={{ gridArea: 'header' }}
                        >
                          Header
                        </div>
                        <div
                          className="bg-light-themesecondarylight-purple p-4 text-light-themesecondarypurple rounded"
                          style={{ gridArea: 'sidebar' }}
                        >
                          Sidebar
                        </div>
                        <div
                          className="bg-actionsuccess-light p-4 text-actionsuccess rounded md:col-span-3"
                          style={{ gridArea: 'main' }}
                        >
                          Main Content Area
                        ...
                        <div
                          className="bg-actionalert-light p-4 text-actionalert rounded col-span-full"
                    ...
                    <p className="text-sm text-blackblack-60 mb-4">
                      The above layout uses grid template areas to create a common web layout
                      pattern with a header, footer, sidebar, and main content area.
                    </p>
                  </div>
                    ...
                    <div className="border border-[#111c2d1a] rounded-lg p-4">
                      <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                        ...
                        <div className="col-span-full md:col-span-4 bg-actionsuccess-light p-4 text-actionsuccess rounded min-h-[200px]">
                          ...
                          <p className="text-sm mt-2">
                            This is the main content section that spans 4 columns on desktop.
                          </p>
                        </div>
...
<div className="grid grid-cols-auto-fit gap-4">
  ...
  <div>Auto Item 3</div>
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-blackblack-80">
                    <li>
                      <strong>Mobile-first approach</strong> - Start with the mobile layout and
                      build up with responsive utilities
                    </li>
                    <li>
                      <strong>Use semantic names</strong> - When using grid areas, use descriptive
                      names like "header", "sidebar", "main", etc.
                    </li>
                    <li>
                      <strong>Consistent gaps</strong> - Maintain consistent gaps in your grid
                      system throughout your application
                    </li>
                    <li>
                      <strong>Consider content</strong> - Choose your grid layout based on your
                      content, not the other way around
                    </li>
                    <li>
                      <strong>Accessibility</strong> - Ensure your layout makes sense when
                      linearized (e.g., for screen readers)
                    </li>
                    <li>
                      <strong>Avoid fixed heights</strong> - Let the content determine the height
                      when possible to maintain flexibility
                    </li>
                    <li>
                      <strong>Combine with Flexbox</strong> - Use Grid for the overall layout and
                      Flexbox for alignment within grid items
                    </li>
                  </ul>
