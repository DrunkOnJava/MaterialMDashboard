                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-blackblack-80 mb-4">
                      This project uses Lucide React for icons. Lucide is a beautiful, consistent,
                      and open-source icon library with more than 700 icons.
                    </p>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-blackblack-80 mb-4">
                      Lucide React is already installed in this project, but for reference, here's
...
yarn add lucide-react`}
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-blackblack-80">
                      <li>
                        <strong>Consistency</strong> - Use the same icon library throughout your
                        application
                      </li>
                      <li>
                        <strong>Sizing</strong> - Maintain consistent icon sizes based on their
                        context (e.g., 16px for inline text, 20px for button icons, 24px for
                        standalone use)
                      </li>
                      <li>
                        <strong>Color</strong> - Use the semantic color system for icons (e.g.,
                        primary color for primary actions, warning colors for alerts)
                      </li>
                      <li>
                        <strong>Accessibility</strong> - Add proper aria-labels for icons when
                        they're the only content in a button or when they convey important meaning
                      </li>
                      <li>
                        <strong>Performance</strong> - Import only the specific icons you need
                  ...
                  <div>
                    ...
                    <p className="text-blackblack-80 mb-4">
                      When using icons, ensure they are accessible to all users including those who
                      use screen readers:
                    </p>
                    <pre className="p-4 bg-surfaceslightgray-20 rounded-lg overflow-x-auto">
                      <code className="text-sm">
