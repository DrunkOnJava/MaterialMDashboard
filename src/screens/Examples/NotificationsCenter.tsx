...
const mockNotifications: Notification[] = [
  {
    ...
    content:
      'Hi there! Just wanted to check in about the project timeline. Do you have a moment to chat?',
...
export const NotificationsCenter = (): JSX.Element => {
  ...
  const toggleNotificationSetting = (
    settingId: string,
    field: 'enabled' | 'email' | 'push' | 'inApp'
  ) => {
    setSettings(prev =>
      prev.map(setting => {
    ...
    <>
      ...
      <main className="flex-1 overflow-auto p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <TabsList className="bg-transparent p-0 h-auto w-full flex">
                ...
                >
                  ...
                  {notifications.length > 0 && (
                    <Badge className="ml-2 bg-light-themeprimaryblue text-white py-0 px-1.5 h-5 min-w-5">
            ...
            <Card
              className="rounded-xl shadow-light-theme-shadow-medium"
                  ...
                  <TabsContent value="all" className="space-y-6">
                    <div className="flex flex-col space-y-4">
                      {settings.map(setting => (
                        <div
                          key={setting.id}
                          className="flex flex-col md:flex-row md:items-center justify-between py-3 px-4 border-b border-[#111c2d1a] last:border-b-0"
                        >
                          <div className="mb-3 md:mb-0">
                            <div className="flex items-center">
                              <h3 className="font-medium">{setting.label}</h3>
                              {setting.enabled && (
                                <Badge className="ml-2 bg-actionsuccess-light text-actionsuccess font-normal">
                                  Enabled
                                </Badge>
                              )}
                              {!setting.enabled && (
                                <Badge className="ml-2 bg-surfaceslightgray-10 text-blackblack-60 font-normal">
                                  Disabled
                                </Badge>
                              )}
                            </div>
                          ...
                          <div className="flex md:flex-col lg:flex-row items-center space-x-4 md:space-x-0 lg:space-x-4 md:space-y-2 lg:space-y-0">
                            <div className="flex items-center space-x-2">
                              <Switch
                                ...
                                onCheckedChange={() =>
                                  toggleNotificationSetting(setting.id, 'enabled')
                                }
                              />
                          ...
                          <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-2">
                              <Switch
                                ...
                                onCheckedChange={() =>
                                  toggleNotificationSetting(setting.id, 'email')
                                }
                          ...
                          <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-2">
                              <Switch
                                ...
                                onCheckedChange={() =>
                                  toggleNotificationSetting(setting.id, 'push')
                                }
                                disabled={!setting.enabled}
                              />
                          ...
                          <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-2">
                              <Switch
                                ...
                                onCheckedChange={() =>
                                  toggleNotificationSetting(setting.id, 'inApp')
                                }
                                disabled={!setting.enabled}
                              />
